...
<body>
	<fieldset>
		...
		<form method="post"><input type="submit" value="전송"/></form>
		<ul style="list-style-type: upper-alpha;">
			...
			<li>요청한 서버의 포트 : <%=request.getServerPort() %></li>
			<!-- 
				IPV6값으로 반환시
	...
	<!-- 
	 ...
	 <fieldset>
	  	...
	  	<h3>프로젝트 생성후 server.xml의 Context태그의 path속성 미 변경시</h3>
	  	Context Root(프로젝트명) : <%=request.getContextPath() %>
	  	<h3>프로젝트 생성후 server.xml의 Context태그의 path속성 변경시("" 혹은 "/")</h3>
