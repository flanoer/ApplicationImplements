...
<body>
	<fieldset>
		...
		<ul style="list-style-type:upper-roman;">
			...
			<li>session의 유효시간(web.xml-단위:분)</li>
			<li>session의 유효시간(메소드-단위:초)</li>
			...
			String lastAcsessString=dateFormat.format(new Date(lastAccess));			
			%>
			<li>세션 최초 생성시간:<%=creationString %></li>
			<li>마지막 요청 시간:<%=lastAcsessString %></li>
		</ul>
