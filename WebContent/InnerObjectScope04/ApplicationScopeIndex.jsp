...
<%
	...
	*/	
	...
	MemberDTO second = new MemberDTO("LEE","1234","이길동",null,"10");
	MemberDTO third = new MemberDTO("PARK","1234","박길동",null,"30");
	//리스트 계열 컬렉션에 객체 저장]
...
<body>
	...
	<fieldset>
		...
		<a href="<%=request.getContextPath() %>/InnerObjectScope04/ApplicationScopeResult.jsp">사용자 클릭에 의한 이동</a>
		<h2>포워드 방식으로 자동이동</h2>
		<%
