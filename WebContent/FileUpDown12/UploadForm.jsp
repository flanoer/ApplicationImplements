...
<body>
	<fieldset>
		<legend>파일 업로드 폼<span style="color:red;font-size:1.8em;font-weight:bold;">${error}</span></legend>
		  <a href="List.jsp">[파일목록으로 가기]</a>
		  <form method="post" 
		          enctype="multipart/form-data"  
		          action="UploadComplete.jsp">
		   <table cellspacing="1" bgcolor="gray">
		    <tr bgcolor="white">
		     <td>올린이</td><td><input type="text" name="name"/></td>   
		    </tr>
		    <tr bgcolor="white">
